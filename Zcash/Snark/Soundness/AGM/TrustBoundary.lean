...
assert_no_sorry assembleQueries_instance_commitment
assert_no_sorry constructIntermediateSets_member_provenance
assert_no_sorry assembledQueryMemberRoute
assert_no_sorry assembledQueryMemberRoute_faithful
assert_no_sorry deployedMemberRef_eq_instanceCommitment
...
assert_no_sorry CircuitConstraintFamily.lookup_constraints_iff_enabledLookups
assert_no_sorry foldPoly_injective_of_length_eq
assert_no_sorry eq_of_compressValues_eq_of_not_mem
assert_no_sorry EnabledLookup.thetaBadSet_card_le
assert_no_sorry uniformChallenge_enabledLookupThetaBadSet
assert_no_sorry EnabledLookup.satisfied_of_compressed
assert_no_sorry lookup_constraints_of_compressed
assert_no_sorry deployed_lookup_subset_of_nonzero_challenges
assert_no_sorry EnabledLookup.satisfied_of_deployed_subset
assert_no_sorry lookup_constraints_of_deployed_subsets
assert_no_sorry EnabledLookup.DeployedWitness.satisfied
assert_no_sorry lookup_constraints_of_deployed_witnesses
assert_no_sorry ConstraintSatisfaction.resolverLookupSubset
assert_no_sorry gate_constraints_of_polynomial_witnesses
assert_no_sorry fixed_constraints_of_requirements
...
assert_no_sorry rowPolynomial_natDegree_lt
assert_no_sorry instanceRowPolynomial_eval
assert_no_sorry resolverEnvironment_instance_of_rowPolynomial
assert_no_sorry coeffsToPoly_polynomialCoefficients
assert_no_sorry rowPolynomial_eq_sum_single
assert_no_sorry polynomialCoefficients_rowPolynomial_eq_sum_single
assert_no_sorry coeffsToPoly_instanceCoefficients
assert_no_sorry LagrangeCommitmentKey.ofPrefix
assert_no_sorry LagrangeCommitmentKey.ofPrefix_generator_of_lt
assert_no_sorry LagrangeCommitmentKey.commitPrefix
assert_no_sorry LagrangeCommitmentKey.commitPrefixNat
assert_no_sorry LagrangeCommitmentKey.commitPrefixNat_eq_commitPrefix
assert_no_sorry LagrangeCommitmentKey.ofPrefix_commitInstance_eq
assert_no_sorry LagrangeCommitmentKey.commitRows_eq
assert_no_sorry LagrangeCommitmentKey.commitInstance_eq
assert_no_sorry instanceOpening_eq_or_relation
assert_no_sorry coeffsToPoly_eq_instanceRowPolynomial_or_relation
assert_no_sorry actionPublicInputs_of_instanceRowPolynomial
...
assert_no_sorry ActionAssignment.ofDecodedMembers_proofIndex
