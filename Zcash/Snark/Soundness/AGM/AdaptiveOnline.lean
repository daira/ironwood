...
requiring phase, cut, or trace objects, over `LabeledOracleComp` query trees
(`Zcash/Common/Oracle/LabeledOracleComp.lean`) whose labels carry the pre-answer AGM
representations.
-/
