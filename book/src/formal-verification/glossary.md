...
<div class="g"><div class="g-head"><span class="term">rewind</span><span class="anchor">Forking.Rewind.roChallenges_reprogramRounds</span></div><div class="def">Re-running the schedule with the oracle reprogrammed at a round prefix: redrawing the IPA round vector is exactly reprogramming the deployed oracle (<code>roChallenges_reprogramRounds</code>). The current soundness endpoint is straight-line and does not use this as an extraction strategy.</div></div>
...
<div class="g"><div class="g-head"><span class="term">capstone</span><span class="anchor">Fixtures.MultiAction.ActionCapstone · Composition.StraightLineConstraint</span></div><div class="def">The deployed straight-line algebraic Fiat–Shamir endpoint carries representations through the adaptive adversary, decodes the deployed instance from a single accepting run, and bounds false-statement acceptance by pinned root events plus plain discrete-log hardness.</div></div>
</section>
